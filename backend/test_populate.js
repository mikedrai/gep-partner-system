...
async function populateDatabase() {
    try {
        console.log('Starting database reset with real Excel data...');
        ...
        console.log(`Successfully inserted ${realPartners.length} partners`);
        ...
        console.log(`Successfully inserted ${realInstallations.length} installations`);
        ...
        console.log('Successfully inserted 3 customer requests');

        console.log('Database successfully populated with real Excel data!');
        console.log({
        ...
        if (error.message && error.message.includes('fetch failed')) {
            console.error('Supabase connection failed. Please check your .env file for valid credentials:');
